...
import OrderListCreate from "./components/OrderCreate";
...
export default function MiniDrawer() {
  ...
  const menu = [
    ...
    { name: "การสั่งซื้อสินค้า", icon: <ShoppingIcon />, path: "/order_lists" },
  ];
        ...
        <main className={classes.content}>
          ...
          <div>
            <Switch>
              ...
              <Route exact path="/order_lists" component={OrderLists} />
              <Route
                exact
                path="/order_list/create"
